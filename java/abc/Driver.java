...
public class Driver {
	...
	private static void driveSelectionSort() {
		...
		Sort<Integer> sort = new Sort.SelectionSort(comparator);
	...
	private static void driveInsertionSort() {
		...
		Sort<Integer> sort = new Sort.InsertionSort(comparator);
	...
	private static void driveBubbleSort() {

		setTestContext("BubbleSort");
		...
		Sort<Integer> sort = new Sort.BubbleSort(comparator);
